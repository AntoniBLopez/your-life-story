  ...
  useEffect(() => {
    setNodes((current) => {
      ...
      return graph.nodes.map((graphNode) => {
        ...
        const keepManualPosition = existing && manualNodeIds.current.has(graphNode.id);
