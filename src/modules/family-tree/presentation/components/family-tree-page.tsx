...
import { Cake, CalendarDays, Download, HeartHandshake, Mail, MapPin, Plus, Upload, UserPlus, UsersRound } from "lucide-react";
...
export function FamilyTreePage({ locale, people, relationships, readOnly, embedded, youPersonId, presets = [], calendar, calendarNotice }: Props) {
  ...
  useEffect(() => {
    ...
    setBirthDateValue(selectedPerson?.birthDate ?? "");
