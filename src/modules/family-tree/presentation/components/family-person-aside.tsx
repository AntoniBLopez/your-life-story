...
export function FamilyPersonAside({
  ...
  return (
    <aside className="absolute right-4 top-4 z-10 w-[min(300px,calc(100%-2rem))] rounded-2xl border border-[var(--moss)]/30 bg-[var(--paper)]/95 p-4 shadow-2xl backdrop-blur">
